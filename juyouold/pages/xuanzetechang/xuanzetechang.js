...
Page({
  ...
  var app = getApp();
  var that = this;
      app.requestGet("https://juyou.17lhd.com/juyou/api/speciality/list").then(res => {
      //请求成功，do something
  ...
  baocun:function(){
    ...
    app.requestPost("https://juyou.17lhd.com/juyou/api/userSpeciality/update?", param).then(res => {
      console.log(res);
      wx.showToast({
        title: res.msg,
        icon:'none'
