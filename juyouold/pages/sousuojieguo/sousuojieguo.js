...
console.log("搜索结果onload")
    ...
    if(prevPage.route=="pages/gengduosousuo/gengduosousuo"){
      app.requestGet("https://juyou.17lhd.com/juyou/api/search?pageNum=1", "keyWord=" + prevPage.data.guanjianzi, "propagandaExperienceId=" + prevPage.data.xuanchuanId, "socialAffairId=" + prevPage.data.shejiaoId,"volunteerRecruitmentId=" + prevPage.data.zhiyuanId).then(res => {
    ...
    if(prevPage.route=="pages/sousuo/sousuo"){
      ...
      app.requestGet("https://juyou.17lhd.com/juyou/api/search?pageNum=1", "keyWord=" + prevPage.data.inputValue).then(res => {
        console.log(res)
    ...
    if(prevPage.route=="pages/sousuojieguo/sousuojieguo"){
      app.requestGet("https://juyou.17lhd.com/juyou/api/search?pageNum=1", "keyWord=" + prevPage.data.inputValueNow, "propagandaExperienceId=" + prevPage.data.xuanchuanIdNow, "socialAffairId=" + prevPage.data.shejiaoIdNow,"volunteerRecruitmentId=" + prevPage.data.zhiyuanIdNow).then(res => {
