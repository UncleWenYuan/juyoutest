...
Page({
  ...
  confirm:function(e){
    ...
    app.requestPost("https://juyou.17lhd.com/juyou/api/activityComment/release?", param).then(res => {
      ...
      app.requestGet("https://juyou.17lhd.com/juyou/api/activityComment/list?", 'activityId=' + this.data.id).then(res => {
        console.log("获取留言")
        console.log(res);
    ...
    if(that.data.youxia=="我要报名"){
      wx.getLocation({
        ...
        success: (res)=> {
          ...
          app.requestPost("https://juyou.17lhd.com/juyou/api/activitySignUp?", param).then(res => {
            if(res.msg=="成功"){
            wx.showToast({
                          title: "审核中",
                          icon:'none'
  ...
  tap3:function(){
    ...
    wx.getLocation({
      ...
      success: (res)=> {
        ...
        param.latitude = res.latitude;
        param.longitude = res.longitude;
        app.requestPost("https://juyou.17lhd.com/juyou/api/activitySignIn/submit?", param).then(res => {
          wx.showToast({
            title: res.msg,
            icon:'none'
          })
...
faburenTap:function(e){
  ...
  onLoad: function (options) {
    ...
    app.requestGet("https://juyou.17lhd.com/juyou/api/activity/detail?", 'id='+this.data.id).then(res => {
