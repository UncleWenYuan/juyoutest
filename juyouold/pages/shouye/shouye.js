...
Page({
  ...
  onShow: function (options) {//**********加代码在if和else里都要加 if是为了防止onLaunch在onload之前运行 else防止onLoad在onLaunch之前 */
    ...
    //   app.requestGet("https://juyou.17lhd.com/juyou/api/activity/newestList?", 'pageNum=1').then(res => {
    //     //请求成功，do something
    ...
    //   })
    //   app.requestGet("https://juyou.17lhd.com/juyou/api/activity/listByPopularity?", 'pageNum=1').then(res => {
    //     //请求成功，do something
    //     //console.log(res.data.list[0].imageUrl)
    ...
    //   })
    //   app.requestGet("https://juyou.17lhd.com/juyou/api/activity/listByDistance?", 'latitude=' + that.data.latitude, "longitude=" + that.data.longitude).then(res => {
    //     //请求成功，do something
    //     //console.log(res.data.list[0].imageUrl)
    ...
    //   })
    //   app.requestGet("https://juyou.17lhd.com/juyou/api/banner/list").then(res => {
    ...
    // }
    // else{
    app.requestGet("https://juyou.17lhd.com/juyou/api/notice/unreadSystemMessageCount").then(res => {
        if(res.data>0){
          wx.showTabBarRedDot({
            index: 2,
          })
