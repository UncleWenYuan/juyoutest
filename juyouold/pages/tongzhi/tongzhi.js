...
var that =this;
  ...
  app.requestGet("https://juyou.17lhd.com/juyou/api/notice/activityCommentReplyMeList?").then(res => {
    that.setData({range:res.data.list})
    console.log(that.data.range)
  }).catch(res => {
  })
  app.requestGet("https://juyou.17lhd.com/juyou/api/notice/activityMessageList?").then(res => {
