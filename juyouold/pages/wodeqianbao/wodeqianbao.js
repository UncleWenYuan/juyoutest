...
Page({
  ...
  onShow: function () {
    ...
    app.requestGet("https://juyou.17lhd.com/juyou/api/rechargePosition/list").then(res => {
  ...
  tap1:function(e){
    ...
    zhifu:function(){
      ...
      app.requestPost("https://juyou.17lhd.com/juyou/api/recharge/weiXinPay?", param).then(res => {
