...
if(this.data.canshorttap==1){
    ...
    wx.showModal({
      ...
      success: function (res) {
        ...
        if (res.confirm) {
          ...
          app.requestPost("https://www.oldageshore.com/juyou/api/activitySignUp/cancel?", param).then(res => {
            wx.showToast({
              title: res.msg,
              icon:'none'
            })
    ...
    wx.showModal({
      ...
      success: function (res) {
        ...
        if (res.confirm) {
          ...
          app.requestPost("https://www.oldageshore.com/juyou/api/activity/cancel?", param).then(res => {
            wx.showToast({
              title: res.msg,
              icon:'none'
            })
  ...
  onLoad: function () {
    ...
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/joinInSignUp?pageNum=1").then(res => {
      that.setData({baomingzhongList:res.data.list})
      console.log(that.data.baomingzhongList)
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/joinInProgress?pageNum=1").then(res => {
      that.setData({jinxingzhongList:res.data.list})
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/joinInSubmit?pageNum=1").then(res => {
      that.setData({tijiaozhongList:res.data.list})
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/joinCompleted?pageNum=1").then(res => {
      that.setData({yiwanchengList:res.data.list})
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/myInAudit?pageNum=1").then(res => {
      that.setData({baomingzhongList2:res.data.list})
      console.log(res.data.list)
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/myInSignUp?pageNum=1").then(res => {
      that.setData({jinxingzhongList2:res.data.list})
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/myInProgress?pageNum=1").then(res => {
      that.setData({tijiaozhongList2:res.data.list})
    }).catch(res => {
    })
    app.requestGet("https://www.oldageshore.com/juyou/api/activity/myCompleted?pageNum=1").then(res => {
