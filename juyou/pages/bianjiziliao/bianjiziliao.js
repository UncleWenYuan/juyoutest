...
Page({
  ...
  var app = getApp();
  var that = this;
  app.requestGet("https://www.oldageshore.com/juyou/api/userInfo/get").then(res => {
    ...
    if(1){
      ...
      if(that.data.onzhengmian==1){
          wx.uploadFile({
            ...
            app.requestPost("https://www.oldageshore.com/juyou/api/userInfo/update?", that.data.postParam).then(res => {
              //请求成功，do something
              console.log(res);
              wx.switchTab({
                url: '/pages/wode/wode',
