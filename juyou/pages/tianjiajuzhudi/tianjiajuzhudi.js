...
Page({
  ...
  onLoad: function (options) {
    ...
    app.requestGet("https://www.oldageshore.com/juyou/api/address/list?").then(res => {
      //请求成功，do something
      var temp = null;
      console.log(res)
      ...
      app.requestGet("https://www.oldageshore.com/juyou/api/address/list?", "superiorId=1").then(res => {
        //请求成功，do something
        var temp = null;
        console.log(res)
        ...
        app.requestGet("https://www.oldageshore.com/juyou/api/address/list?", "superiorId=35").then(res => {
          //请求成功，do something
          var temp = null;
          console.log(res)
  ...
  app.requestPost("https://www.oldageshore.com/juyou/api/userAddress/update?", param).then(res => {
    //请求成功，do something
    console.log(res)
    wx.showToast({
      title: '保存成功',
  ...
  bindMultiPickerColumnChange: function (e) {
    ...
    switch (e.detail.column) {
      case 0:
        ...
        app.requestGet("https://www.oldageshore.com/juyou/api/address/list?", "superiorId=" + that.data.multiArray[0][temp.multiIndex[0]].id).then(res => {
          //请求成功，do something
          ...
          app.requestGet("https://www.oldageshore.com/juyou/api/address/list?", "superiorId=" + that.data.multiArray[1][that.data.multiIndex[1]].id).then(res => {
            //请求成功，do something
        ...
        break;
      case 1:
        app.requestGet("https://www.oldageshore.com/juyou/api/address/list?", "superiorId=" + that.data.multiArray[1][temp.multiIndex[1]].id).then(res => {
          //请求成功，do something
          temp.multiArray[2] = res.data;
          that.setData({
            multiArray: temp.multiArray,
