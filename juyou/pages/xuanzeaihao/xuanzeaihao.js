...
Page({
  ...
  var app = getApp();
  var that = this;
      app.requestGet("https://www.oldageshore.com/juyou/api/hobby/list").then(res => {
      //请求成功，do something
  ...
  baocun:function(){
    ...
    app.requestPost("https://www.oldageshore.com/juyou/api/userHobby/update?", param).then(res => {
      console.log(res);
      wx.showToast({
        title: res.msg,
        icon:'none'
