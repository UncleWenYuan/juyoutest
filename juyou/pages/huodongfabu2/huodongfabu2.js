...
jixu:function(){
  ...
  tianjiafujian:function(e) {
    ...
    wx.chooseMessageFile({
      ...
      //     },
      //     name: 'enclosure',
      //     url: 'https://www.oldageshore.com/juyou/api/enclosure/upload',
      //     success:function(e){
      //       console.log(e)
...
var that = this;
  ...
  onLoad: function (options) {
    ...
    app.requestGet("https://www.oldageshore.com/juyou/api/enterpriseCertification/auditPassList").then(res => {
      console.log(res)
