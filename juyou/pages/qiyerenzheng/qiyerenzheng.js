...
Page({
  ...
  onLoad: function (options) {
    ...
    var app = getApp();
    var that = this;
    app.requestGet("https://www.oldageshore.com/juyou/api/enterpriseCertification/applyList?pageNum=1").then(res => {
        ...
        wx.uploadFile({
          ...
          success:function(e){
            ...
            wx.uploadFile({
              ...
              app.requestPost("https://www.oldageshore.com/juyou/api/enterpriseCertification/apply?", that.data.postParam).then(res => {
                //请求成功，do something
                console.log(res);
