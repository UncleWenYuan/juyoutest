...
bianjiziliao:function(){
  ...
  app.requestPost("https://www.oldageshore.com/juyou/api/userLike/like?", param).then(res => {
    if(res.code==1){
...
onShow: function (options) {
    ...
    app.requestGet("https://www.oldageshore.com/juyou/api/userInfo/homePage?", "targetUserId=" + prevPage.data.userId).then(res => {//1001换成app.globalData.userId
