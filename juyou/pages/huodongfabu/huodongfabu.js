...
zhiye:function(){
  ...
  onLoad: function (options) {
    ...
    app.requestGet("https://www.oldageshore.com/juyou/api/education/list").then(res => {
    var temp = [{"name":"不限"}];
    temp = temp.concat(res.data);
    console.log(temp);
  ...
  app.requestGet("https://www.oldageshore.com/juyou/api/ageRange/list").then(res => {
    ...
    //prevPage.data.on1&&prevPage.data.on2&&prevPage.data.on3&&prevPage.data.on4&&prevPage.data.on5&&prevPage.data.on6&&prevPage.data.on7&&prevPage.data.onzhuti&&prevPage.data.onshuoming&&prevPage.data.ontupian
      ...
      if(1){
        ...
        wx.uploadFile({
          ...
          app.requestPost("https://www.oldageshore.com/juyou/api/activity/release?", that.data.postParam).then(res => {
            wx.hideToast({
              complete: () => {
